...
export const MAX_LENGTH = Number(retrieveEnvVariable('MAX_SNIPE_LENGTH', logger));
export const SELL_RETRIES_INTERVAL = Number(retrieveEnvVariable('SELL_RETRIES_INTERVAL',  logger));
